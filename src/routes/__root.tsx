...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "RotaMais Connecta — Mova-se. Conecte-se. Descubra." },
      { name: "description", content: "Super app de mobilidade urbana, rede social por proximidade e negócios locais em um só lugar." },
      { property: "og:title", content: "RotaMais Connecta" },
      { property: "og:description", content: "Mobilidade, pessoas e negócios locais integrados em um só app." },
