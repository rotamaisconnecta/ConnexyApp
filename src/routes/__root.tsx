...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Connexy — Tudo mais perto de você!" },
      {
        name: "description",
        content:
          "Super app de rede social por proximidade e negócios locais em um só lugar, com mobilidade urbana incluso",
      },
      { property: "og:title", content: "Connexy — Tudo mais perto de você!" },
      {
      ...
      { name: "twitter:title", content: "Connexy — Tudo mais perto de você!" },
      {
      ...
      },
      {
        property: "og:image",
        content:
          "https://storage.googleapis.com/gpt-engineer-file-uploads/EIHoZ9gNiOTlY9D5Fg74CRibMBi1/social-images/social-1783389582373-banner_3.webp",
      },
      {
        name: "twitter:image",
        content:
