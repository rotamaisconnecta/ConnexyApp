      ...
      {open && (
        ...
        >
          <div className="relative overflow-hidden rounded-2xl bg-gradient-brand p-4 text-white shadow-elegant">
            <button onClick={close} className="absolute top-2 right-2 h-7 w-7 grid place-items-center rounded-full bg-white/15 hover:bg-white/25">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-[11px] uppercase tracking-wider opacity-90">Promoção perto de você</p>
                <p className="font-display text-lg font-semibold leading-tight">Você está a 150 m de uma oferta especial</p>
                <p className="mt-1 text-sm opacity-90">Café Central — 20% OFF em cafés especiais</p>
                <div className="mt-3 flex gap-2">
                  <Link to="/local/$id" params={{ id: "cafe-central" }} onClick={close}
                        className="rounded-full bg-white text-primary text-xs font-semibold px-3 py-1.5 shadow-soft">
                    Ver oferta
                  </Link>
                  <button onClick={close} className="rounded-full bg-white/15 text-white text-xs font-semibold px-3 py-1.5">
                    Agora não
                  </button>
                </div>
              </div>
