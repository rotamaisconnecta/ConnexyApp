  ...
  return (
    <motion.li variants={centerButton} className="flex-1 flex justify-center -mt-5">
      <motion.button
        ...
        className="relative h-16 w-16 rounded-full bg-gradient-to-br from-brand-primary to-brand-secondary shadow-xl flex items-center justify-center z-10 outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2"
      >
