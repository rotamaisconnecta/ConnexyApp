          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto px-4 pb-4 no-scrollbar">
                ...
                {person.headline && (
                  <p className="mt-1.5 text-xs text-primary font-medium">{person.headline}</p>
                )}
                ...
                {person.stats && (
                  <div className="mt-5 flex gap-6">
                    ...
                    <div className="text-center">
                      <div className="font-display font-bold text-sm">{person.stats.meetups}</div>
                      <div className="text-[10px] text-muted-foreground">Encontros</div>
                    </div>
                  </div>
                )}
              </div>
